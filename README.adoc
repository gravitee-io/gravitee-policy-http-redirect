...
image:https://circleci.com/gh/gravitee-io/gravitee-policy-http-redirect.svg?style=svg["CircleCI", link="https://circleci.com/gh/gravitee-io/gravitee-policy-dynamic-routing"]
